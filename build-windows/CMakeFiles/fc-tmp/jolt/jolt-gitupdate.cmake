...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v5.5.0"
  WORKING_DIRECTORY "/home/david/Dokumente/coding_projects/bugmin/build-windows/_deps/jolt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/david/Dokumente/coding_projects/bugmin/build-windows/_deps/jolt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/david/Dokumente/coding_projects/bugmin/build-windows/_deps/jolt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
